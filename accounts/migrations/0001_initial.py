...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relative', models.CharField(choices=[('father', 'Father'), ('mother', 'Mother'), ('sister', 'Sister'), ('brother', 'Brother'), ('grand father', 'Grand father'), ('grand mother', 'Grand mother')], max_length=50, verbose_name='Relative Position')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disease', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.disease')),
                ('family_disease', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.familydisease', verbose_name='Family Disease')),
            ],
        ),
        migrations.CreateModel(
            name='doctor',
